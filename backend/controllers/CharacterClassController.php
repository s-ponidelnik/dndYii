...
use backend\models\CharacterClassSearch;
...
class CharacterClassController extends Controller
{
    ...
    {
        $searchModel = new CharacterClassSearch();
    ...
    /**
     * Creates a new CharacterClass model.
    ...
    /**
     * Updates an existing CharacterClass model.
    ...
    /**
     * Deletes an existing CharacterClass model.
    ...
    {
        if (($model = CharacterClass::findOne($id)) !== null) {
            return $model;
        }
