...
use backend\models\SpellSearch;
...
class SpellController extends Controller
{
    ...
    /**
     * Updates an existing Spell model.
    ...
    /**
     * Deletes an existing Spell model.
    ...
    {
        if (($model = Spell::findOne($id)) !== null) {
            return $model;
        }
